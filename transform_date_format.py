...
date_formats = [
    ...
    "%B. %d, %Y",
    "%d %B %Y",
    "British days_numbers",
    "British days_letters",
    "American days_numbers",
    "American days_letters",
]
months = [
    "January",
    "February",
...
def transform_date_type(
    old_date: str, change_month: bool = True, change_day: bool = True
):
    """
    ...
    if new_date_format == "British days_numbers":
        ...
        new_date = (
            "the "
            + str(days_letters[int(new_day) - 1]).capitalize()
            + " of "
            + new_month
            + ", "
            + year
