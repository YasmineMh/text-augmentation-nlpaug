...
class NLPAugmenters:
  ...
  def synonymAugmenter(self, text, aug_p=0.5, number_generated_examples=5):
    """
  ...
  def antonymAugmenter(self, text, number_generated_examples=5):
    """
  ...
  def contextualWordEmbsAugmenter(self, text, model_path='nlpaueb/legal-bert-base-uncased', action="insert", number_generated_examples=5):
    """
    ...
    """
    contextualWEAug = naw.ContextualWordEmbsAug(model_path=model_path, action=action)
  ...
  def BackTranslationAugmenter(self, text, from_model_name='facebook/wmt19-en-de', to_model_name="facebook/wmt19-de-en"):
    """
  ...
  def ContextualWordEmbsForSentenceAugmenter(self, text, model_path='xlnet-base-cased', number_generated_examples=5):
    """
  ...
  def generate_text_before_label_with_autoregressive_model(self, text, text_limit = 11, number_generated_examples = 5):
    """
    ...
    generated_sentences = self.ContextualWordEmbsForSentenceAugmenter(first_sentence_to_be_generated, number_generated_examples=number_generated_examples)
    ...
    if index_last_sentence == -1:
      ...
      completed_sentences = self.synonymAugmenter(last_part, aug_p=0.6, number_generated_examples=number_generated_examples)
      concat_lists = []
  ...
  def generate_text_after_label_with_autoregressive_model(self, text, text_limit = 9, number_generated_examples = 5):
    """
    Augmenter that inserts sentence according to XLNet.
    ...
    if index_after_first_sentence == -1:
      ...
      first_sentence_to_be_generated = self.synonymAugmenter(first_part, aug_p=0.6, number_generated_examples=number_generated_examples)
      ...
      if len(tokens) >= text_limit:
        ...
        sentence_to_be_generated = " ".join(tokens[:len(tokens)]) + " "
    #Complete the sentence
    generated_sentences = self.ContextualWordEmbsForSentenceAugmenter(sentence_to_be_generated, number_generated_examples=number_generated_examples)
    #Concatenate the paraphrased sentence and the compeleted sentence
    if first_sentence_to_be_generated:
      concat_lists = [i+". "+generated_sentences[index] for index,i in enumerate(first_sentence_to_be_generated)]
    else:
      concat_lists = generated_sentences
    return concat_lists


  def augmente_data_using_de_backtranslation(self, original_sentence, data_to_augmente):
    """
    Augmenter that leverages two translation models for augmentation. 
    ...
    Args:
        ...
        data_to_augmente: List of augmented data from original_sentence
    ...
    """
    de_aug_data = []
    de_aug_data.append(self.BackTranslationAugmenter(original_sentence, "facebook/wmt19-en-de", "facebook/wmt19-de-en")[0])
    for i in data_to_augmente:
      de_aug_data.append(self.BackTranslationAugmenter(i, "facebook/wmt19-en-de", "facebook/wmt19-de-en")[0])
    return list(set(de_aug_data))


  def augmente_data_using_ru_backtranslation(self, original_sentence, data_to_augmente):
    """
    Augmenter that leverages two translation models for augmentation. 
    ...
    """
    ru_aug_data = []
    ru_aug_data.append(self.BackTranslationAugmenter(original_sentence, "facebook/wmt19-en-ru","facebook/wmt19-ru-en")[0])
    for i in data_to_augmente:
      ru_aug_data.append(self.BackTranslationAugmenter(i, "facebook/wmt19-en-ru","facebook/wmt19-ru-en")[0])
    return list(set(ru_aug_data))


  def augmente_data_using_ar_backtranslation(self, original_sentence, data_to_augmente):
    """
    Augmenter that leverages two translation models for augmentation. 
    ...
    """
    ar_aug_data = []
    ar_aug_data.append(self.BackTranslationAugmenter(original_sentence, "Helsinki-NLP/opus-mt-en-ar","Helsinki-NLP/opus-mt-ar-en")[0])
    for i in data_to_augmente:
      ar_aug_data.append(self.BackTranslationAugmenter(i, "Helsinki-NLP/opus-mt-en-ar","Helsinki-NLP/opus-mt-ar-en")[0])
