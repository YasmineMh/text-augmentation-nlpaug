...
for index_element, element in enumerate(dataset):
  ...
  first_parts += nlpAugmenter.synonymAugmenter(first_sentence, number_generated_examples=5); print("[1/8] synonymAug Done")
  first_parts += nlpAugmenter.antonymAugmenter(first_sentence, number_generated_examples=5); print("[2/8] antonymAug Done")
  first_parts += nlpAugmenter.contextualWordEmbsAugmenter(first_sentence, number_generated_examples=5); print("[3/8] contextualWordEmbsAug - insert Done")
  first_parts += nlpAugmenter.contextualWordEmbsAugmenter(first_sentence, action="substitute", number_generated_examples=5); print("[4/8] contextualWordEmbsAug - substitute Done")
  first_parts += nlpAugmenter.generate_text_before_label_with_autoregressive_model(first_sentence, number_generated_examples = 5); print("[5/8] xlnetAug Done")
  first_parts += nlpAugmenter.augmente_data_using_de_backtranslation(first_sentence, first_parts); print("[6/8] deBacktranslationAug Done")
  first_parts += nlpAugmenter.augmente_data_using_ru_backtranslation(first_sentence, first_parts); print("[7/8] ruBacktranslationAug Done")
  first_parts += nlpAugmenter.augmente_data_using_ar_backtranslation(first_sentence, first_parts); print("[8/8] arBacktranslationAug Done")
  print("{} new sentence generated for the paragraph's first part. Unique sentences = {}".format(len(first_parts), len(list(set(first_parts)))))
  ...
  second_parts += nlpAugmenter.synonymAugmenter(second_sentence, number_generated_examples=5); print("[1/8] synonymAug Done")
  second_parts += nlpAugmenter.antonymAugmenter(second_sentence, number_generated_examples=5); print("[2/8] antonymAug Done")
  second_parts += nlpAugmenter.contextualWordEmbsAugmenter(second_sentence, number_generated_examples=5); print("[3/8] contextualWordEmbsAug - insert Done")
  second_parts += nlpAugmenter.contextualWordEmbsAugmenter(second_sentence, action="substitute", number_generated_examples=5); print("[4/8] contextualWordEmbsAug - substitute Done")
  second_parts += nlpAugmenter.generate_text_after_label_with_autoregressive_model(second_sentence, number_generated_examples = 5); print("[5/8] xlnetAug Done")
  second_parts += nlpAugmenter.augmente_data_using_de_backtranslation(second_sentence, second_parts); print("[6/8] deBacktranslationAug Done")
  second_parts += nlpAugmenter.augmente_data_using_ru_backtranslation(second_sentence, second_parts); print("[7/8] ruBacktranslationAug Done")
  second_parts += nlpAugmenter.augmente_data_using_ar_backtranslation(second_sentence, second_parts); print("[8/8] arBacktranslationAug Done")
  print("{} new sentence generated for the paragraph's second part. Unique sentences = {}".format(len(second_parts), len(list(set(second_parts)))))
  ...
  for index in range(min_data):
    new_paragraph = first_parts[index] + " " + dates[index] + " " + second_parts[index]
  ...
  print("{} new paragraphs. Unique paragraphs = {}".format(len(paragraphs), len(list(set(paragraphs)))))
  ...
  if min_data < 200:
    ...
    while remaining_paragraphs > 0:
      ...
      new_paragraph = first_parts[random_first_part] + " " + dates[random_date] + " " + second_parts[random_second_part]
    ...
    print("{} new paragraphs after combination. Unique paragraphs = {}".format(len(paragraphs), len(list(set(paragraphs)))))

  #Save the augmented data of each paragraph in a json file
  with open("augmentation_paragraph_number_{}.json".format(index_element+1), "w") as final:
